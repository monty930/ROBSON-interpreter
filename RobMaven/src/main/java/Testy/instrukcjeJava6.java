...
public class instrukcjeJava6 {
    ...
    public static double wykonaj() {
        ...
        and(and(większy(liczba(1.5), liczba(-1.3)), mniejszy(liczba(-1.5), liczba(1.3))), and(większyRówny(liczba(1.5), liczba(1.5)), mniejszyRówny(liczba(-1.5), liczba(-1.5))));
        ;
        return (wynik);
    }
