...
przypisz("numer", liczba(10.0));
if(równy(mniejszyRówny(zmienna("numer"), liczba(2.0)), 1) == 1) {
liczba(1.0);

} else {
przypisz("x1", liczba(1.0));
przypisz("x2", liczba(1.0));
przypisz("index", liczba(3.0));
while(równy(mniejszyRówny(zmienna("index"), zmienna("numer")), 1) == 1) {
przypisz("temp", plus(zmienna("x1"), zmienna("x2")));
przypisz("x1", zmienna("x2"));
przypisz("x2", zmienna("temp"));
przypisz("index", plus(zmienna("index"), liczba(1.0)));
