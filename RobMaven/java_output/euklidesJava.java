...
przypisz("x1", liczba(15.0));
przypisz("x2", liczba(21.0));
while(równy(not(równy(zmienna("x1"), zmienna("x2"))), 1) == 1) {
if(równy(większy(zmienna("x1"), zmienna("x2")), 1) == 1) {
przypisz("x1", minus(zmienna("x1"), zmienna("x2")));

} else {
przypisz("x2", minus(zmienna("x2"), zmienna("x1")));
